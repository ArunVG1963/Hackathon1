...
function returnResults() {
    ...
    if (correctAnswerScore == 0) {
        ...
        personalMessage.innerHTML = "Good Job! your level of knowledge is moderate";
    } else if (correctAnswerScore == 10) {
        personalMessage.innerHTML = "congratulation! you got higher knowledge level";
    }
}
...
let exitGameBtn = document.addEventListener('keydown', function(event) {
    if (event.key === 'Escape') {
